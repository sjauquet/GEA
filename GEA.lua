...
-- v 5.40
-- Optimisation possible, cf : GEA.optimize = GEA.typeOptimize["IMMEDIATE_ONLY"]
-- ==================================================
...
function config()
  ...
  -- ------------------------------------------------------------
  -- [FR] Variable Globale optionnel pour autoriser GEA à s'exécuter
